...
#ifndef QCP_LIB_DECL_TEMPLATE
#define QCP_LIB_DECL_TEMPLATE
#endif
...
template <class DataType>
class QCP_LIB_DECL_TEMPLATE QCPDataContainer
{
public:
...
template <class DataType>
class QCP_LIB_DECL_TEMPLATE QCPAbstractPlottable1D : public QCPAbstractPlottable, public QCPPlottableInterface1D
{
